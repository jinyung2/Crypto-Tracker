    ...
    return (
        <div>
            <div className="nav-buttons">
                    <Link id="loginLink" to="/login"><button style={{backgroundColor: "#979797"}} className="lsButton" onClick={props.clearError}>Login</button></Link>
                    <Link id="signUpBtn" to="/signup"><button className="lsButton" onClick={props.clearError}>Sign Up</button></Link>
                </div>
            <form id="signUpForm">
